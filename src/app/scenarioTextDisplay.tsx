export default function ScenarioTextDisplay({
  ...
  return (
    <div className="flex md:flex-col max-h-20 md:max-h-none md:w-fit gap-x-4 gap-y-2 rounded-lg border border-purple-500/20 bg-gradient-to-tl from-sky-900/10 to-purple-800/10 p-3 md:p-8 shadow shadow-purple-900 backdrop-blur-2xl">
      {paidAfter === -1 ? (
