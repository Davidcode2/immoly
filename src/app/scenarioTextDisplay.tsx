export default function ScenarioTextDisplay({
  ...
  return (
    <div className="flex flex-col text-center md:text-start items-center md:items-start gap-x-4 gap-y-2 rounded-lg p-3 backdrop-blur-2xl md:my-0 md:h-48 md:max-h-none md:p-8 md:shadow">
      {paidAfter === -1 ? (
