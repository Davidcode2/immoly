  ...
  return (
    <div className="px-3 pt-3">
      ...
      >
        ...
        <div className="rounded-lg border border-slate-500/20 bg-gradient-to-tl from-purple-800/30 to-neutral-900/70 p-4 shadow backdrop-blur-2xl md:hidden md:p-8">
          <Hero />
        </div>
