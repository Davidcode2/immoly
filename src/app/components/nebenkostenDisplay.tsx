...
export default function NebenkostenDisplay({ calculationData }: PropTypes) {
  ...
  return (
    <div className="flex text-xs md:text-base sm:col-span-2 justify-center md:justify-start items-center gap-6 rounded-lg py-4 px-6 md:shadow backdrop-blur-2xl">
