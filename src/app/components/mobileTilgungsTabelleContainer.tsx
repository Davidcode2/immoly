    ...
    <div className="mx-4 my-14 sm:mx-0 md:hidden">
      <div className="grid grid-cols-2 gap-4 my-4">
        <div className="shadow p-4 grid gap-2 sm:grid-cols-[50px_1fr] rounded-lg">
          <div className="p-2 h-10 w-10 text-center rounded-full bg-[var(--primary)] dark:text-[var(--background)]">1</div>
          <div>Tippe auf einen Eintrag um einen Tilgungswechsel vorzunehmen</div>
        </div>
        <div className="shadow p-4 grid gap-2 sm:grid-cols-[50px_1fr] rounded-lg">
          <div className="p-2 h-10 w-10 text-center rounded-full bg-[var(--primary)] dark:text-[var(--background)]">2</div>
