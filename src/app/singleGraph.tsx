...
export default function SingleGraph({
  ...
  return (
    <div className="flex min-w-[320px] flex-col justify-between rounded-xl bg-gradient-to-br from-[var(--background)] to-[var(--light-accent)]/5 p-6 shadow backdrop-blur-lg dark:bg-neutral-800/30">
