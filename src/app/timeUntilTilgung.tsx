...
export default function TimeUntilTilgung({
  ...
  return (
    <div className="sm:h-none flex overflow-clip rounded-lg p-5 shadow backdrop-blur-2xl md:mx-0 md:my-0 md:max-h-56 md:max-w-none md:p-8 md:text-start">
      <div>
        <Image
          className={`${paidAfter === -1 ? "block" : "hidden"} absolute top-0 left-12 opacity-20 md:top-12 md:left-28`}
          src={AttentionIcon}
          height="200"
          width="200"
          alt="Achtung"
        ...
        />
        <div className="hidden md:block h-20 w-40">
          {paidAfter !== -1 && (
