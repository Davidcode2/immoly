...
import AnimatedMenuEntry from "../header/AnimatedMenuEntry";
export default function Footer() {
  return (
    <div className="grid gap-y-8 bg-[var(--secondary)] p-8 py-40 sm:px-24 dark:bg-[var(--background)]">
      <div className="grid">
        <AnimatedMenuEntry href="/" text="Rechner" arrowPosition="right" />
        <AnimatedMenuEntry
          href="/about"
          text="Über Immoly"
          arrowPosition="right"
      ...
      <div className="grid gap-y-8">
        <div className="flex gap-2">
          <a href="https://github.com/davidcode2" aria-label="Github profile">
            <svg
              viewBox="0 0 100 100"
